      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Главная</a></span> <span>Избранное</span></p>
						    ...
						    <tbody>
						      <tr class="text-center">
						        ...
						        <td class="product-name">
						        	...
						        	<p>Наслаждайтесь взрывом вкуса с нашим свежим болгарским перцем!</p>
						        </td>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="product-name">
						        	<h3>Томат</h3>
						        	<p>Сочные томаты - вкус и польза в каждом кусочке. Закажите прямо сейчас!</p>
						        </td>
						        
						        <td class="price">2 955 ₸</td>
